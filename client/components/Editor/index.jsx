...
class Editor extends Component {
    constructor(props) {
        ...
        let { activeTab, activeSlideIndex, match, scenarioId } = this.props;

        if (!scenarioId) {
            // /editor/copy/
            if (
                match.path.startsWith('/editor/copy/') &&
                (match.params && match.params.id)
            ) {
                activeTab = 'copy';
                scenarioId = match.params.id;
            } else {
                scenarioId = match.params.id || 'new';
            }
        }
        ...
        if (scenarioId !== 'new' && activeTab !== 'copy') {
